...
genai.configure(api_key="AIzaSyAr-sNLLKURIF1Uv8CalPkmN3HMAC9wUjA")
...
def extract_text(file: UploadFile, content: bytes) -> str:
    ...
    try:
        if ext == "pdf":
        ...
        elif ext in ["py", "html", "css", "xml", "txt", "java", "js", "c"]:
            ...
            import pandas as pd
            temp_path = f"temp_excel.{ext}"
            with open(temp_path, "wb") as f:
                f.write(content)
            df_sheets = pd.read_excel(temp_path, sheet_name=None)
